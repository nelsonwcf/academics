...
# a)
xopt = _optim_u.gold(f, xl, xu, es100=e); #debug = True
print "a)", xopt;
...
x2 = 2.5;
iter = 4;
xopt = _optim_u2.parabolic(f, x0, x1, x2, imax = 100, es100 = e); #debug = True
print "b)", xopt;
...
xopt = _optim_u2.newton(df, df2, x0, es100=e); #debug = True
print "c)",xopt;
print
...
xopt = _roots.bisect(df, xl, xu, es100 = e); #debug = True
