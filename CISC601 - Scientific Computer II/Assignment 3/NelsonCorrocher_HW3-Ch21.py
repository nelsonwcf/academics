...
# One final comment: The equation that provide the maximum error for both methods requires derivatives of the equation.
# If the equation is not derivable (non-continuos
